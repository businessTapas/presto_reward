                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" class="form-control" placeholder="description" id="description">{{ $data->description }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <img src="{{asset($data->image)}}" alt="Company Logo" class="img-fluid">
