<div class="vertical-menu">
    ...
    <div class="navbar-brand-box">
        <a href="#" class="logo logo-dark">
            ...
            <span class="logo-lg">
                <img src="{{ asset('images')}}/setting/logo-sm.png" alt="" height="" width="80">
                {{-- <img src="{{optional(DB::table('settings')->first())->company_logo ?? 'default.jpg'}}" width="80"> --}}
                {{-- <img src="{{ asset('images/setting[0]')}}" alt="" height="" width="80"> --}}
            </span>
        </a>
        ...
        <a href="#" class="logo logo-light">
            ...
            <span class="logo-lg">
                <img src="{{ asset('images') }}/setting/logo-sm.png" alt="" height="40">
            </span>
        </a>
    </div>
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{route('admin.company')}}"  class="">
                        ...
                        <span class="menu-item" data-key="t-company">Company</span>
                    </a>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('admin.catalog')}}">Catalogue</a></li>
                ...
                <li>
                    <a href="{{route('redeemption')}}" class="">
                        ...
                        <span class="menu-item" data-key="t-redem">Redemption</span>
                    </a>
                </li>
