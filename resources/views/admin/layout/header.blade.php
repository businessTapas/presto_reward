                                ...
                                <div class="d-flex border-bottom align-items-start">
                                    ...
                                    <div class="flex-grow-1 bg-light" style="text-align: center">
                                        ...
                                        <div class="text-muted">
                                            ...
                                            <tr>
                                                    <p class="mb-0 font-size-13" style="padding: 10px 0 0 0"><i class="bx bx-bell icon-sm"></i>{{$notim->message}}
                                                    <span class="badgebg-success-subtle text-success">Review</span></p>
                                                        @php
