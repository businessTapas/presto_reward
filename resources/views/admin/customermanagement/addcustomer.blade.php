                            ...
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    ...
                                    <a href="{{route('admin.customerlist')}}">
                                        <button type="submit" class="btn btn-primary add-list btn-md btn-rounded" ><i class="uil-arrow-left"></i>Back to Customer List</button>
                                    </a>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="datepicker" class="form-control" placeholder="Enter Date Of Birth"
                                                name="dob" required
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Enter Address Line 1" name="address_1" required>
                                                @error('address_1')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Enter Address Line 2" name="address_2">
                                                @error('address_2')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select type="text" class="form-control selectpicker"
                                                    data-live-search="true" name="state" id="state">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select type="text" class="form-control selectpicker"
                                                    data-live-search="true" name="district" id="district">
