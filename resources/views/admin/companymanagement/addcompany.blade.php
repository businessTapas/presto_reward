    ...
    <div class="page-content" style="padding:35px 0 80px 0">
        ...
        <div class="container-fluid">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <h5 class="font-size-16 mb-1">Create Company by Admin</h5>
                                            <p class="text-muted text-truncate mb-0">Fill all information below</p>
                                        </div>
                                        <div class="flex-shrink-0">
                                        <a href="{{route('admin.company')}}">
                                            <button type="submit" class="btn btn-primary add-list btn-md btn-rounded" ><i class="uil-arrow-left me-2"></i>Back to Company List</button>
                                        </a>
                                        </div>
                                        <div class="flex-shrink-0">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" class="form-control"
                                                        placeholder="Enter Company Address" name="company_address"></textarea>
            ...
            <div class="col-sm-12 text-center">
                <button type="submit"
                class="btn btn-success btn-rounded" ><i class="uil uil-check me-2"></i>Add Company</button>
            </div>
        </form>
        </div>
    </div>
