...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="assets/css/toasted/toastr.min.css">
...
<body class="bg-white">
    ...
    <div class="auth-page d-flex align-items-center min-vh-100">
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="col-lg-7">
                    <div class="d-flex flex-column h-100 py-5 px-4 justify-content-between position-relative auth-feat" style="background: url(assets/images/auth-bg.jpg)">
                        ...
                        <div class="col-lg-10">
                            <div class="d-flex flex-column h-100 py-5 px-4 justify-content-between">
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <div class="d-flex py-3 g-3 justify-content-center">
                                        <a href="" class="text-muted">Terms of use</a>
                                        <span class="text-gray-600 d-inline-block px-2">|</span>
                                        <a href="" class="text-muted">Privacy policy</a>
                                    </div>
                                    <p class="mb-0">©
                                        <script>
                                            document.write(new Date().getFullYear())
                                        </script> Presto Plast. Crafted with by
                                        Timd
                                    </p>
                                </div>
                            </div>
