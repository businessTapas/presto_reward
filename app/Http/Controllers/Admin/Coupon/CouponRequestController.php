...
//dd($coupon->couponRequest->company);
     ...
     $textWithNewLines = 'Coupon No:'.$coupon->coupon_code.PHP_EOL .'Amount:'.$coupon->couponRequest->amount.PHP_EOL.'Brand:'.$coupon->couponRequest->company->company_name.PHP_EOL.'Product Name:'.$coupon->couponRequest->product->product_name;
